...
function Router() {
  return (
    <Switch>
      ...
      <Route path={`${adminRoutes.kitchen}/food`}>
        <ProtectedRoute><Kitchen station="food" /></ProtectedRoute>
      </Route>
      <Route path={`${adminRoutes.kitchen}/drinks`}>
        <ProtectedRoute><Kitchen station="drinks" /></ProtectedRoute>
      </Route>
